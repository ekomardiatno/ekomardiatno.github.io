...
import TheBeginning from "./Emvite/TheBeginning";
import Toast from "./Emvite/Toast";

const demoData: WeddingInvitationDetailDataType = {
  invitationId: "demo-the-beginning-001",
  guest: {
    id: "guest-001",
    name: "Budi Santoso",
  },
...
export default function EmviteDemoTheBeginning() {
