  ...
  return (
    <div className="">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-2xl font-bold mb-6">Privacy Policy for Eksamart</h2>
        <p className="mb-4">
          Eko Mardiatno built the Eksamart app as a Free app. This SERVICE is
        ...
        <p className="mb-4">
          ...
          Terms and Conditions, which are accessible at Eksamart unless otherwise
        ...
        <p className="mb-4">This policy is effective as of 2022-10-20</p>
        <p className="mb-4">
