export default function EmvitePrivacyPolicy() {
  return (
    <div className="">
      <div className="py-24 banner overlay-dark-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold mb-3">EMVITE</h1>
          <p className="text-lg text-slate-200 mb-4">Policy Privacy</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-2xl font-bold mb-6">Privacy Policy for EMVITE</h2>
        <p className="mb-4">
          Eko Mardiatno built the EMVITE app as a Free app. This SERVICE is
        ...
        <p className="mb-4">
          ...
          Terms and Conditions, which are accessible at EMVITE unless otherwise
        ...
        <p className="mb-4">This policy is effective as of 2026-02-11</p>
        <p className="mb-4">
