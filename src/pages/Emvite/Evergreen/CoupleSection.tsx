...
export default function CoupleSection() {
  ...
  return (
    <section id="couple" className="px-6 py-20 text-stone-800">
      <div className="mb-16 text-center">
        <h2 className="mb-4 font-serif text-3xl text-emerald-800">Mempelai</h2>
        <p className="text-sm text-stone-500">Dengan penuh rasa syukur</p>
      </div>
