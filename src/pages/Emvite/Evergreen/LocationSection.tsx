...
export default function LocationSection() {
  ...
  return (
    <section id="location" className="bg-white px-6 py-20 text-stone-800">
      <div className="mb-12 text-center">
        <h2 className="mb-4 font-serif text-3xl text-emerald-800">Lokasi Acara</h2>
        <p className="text-sm text-stone-500">Kami nantikan kehadiran Anda</p>
      </div>
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="flex flex-col items-center gap-2">
          ...
          {mainEvent.address && (
            <p className="text-sm text-stone-500">{mainEvent.address}</p>
          )}
        </div>
            ...
            <div className="text-center">
              <a
                href={`https://www.google.com/maps?q=${mainEvent.location
                  ...
                  .join(",")}`}
                target="_blank"
                className="inline-flex items-center justify-center rounded-full border border-emerald-800 px-8 py-3 text-sm tracking-wide text-emerald-800 transition hover:bg-emerald-800 hover:text-white"
              >
                Buka di Google Maps
              </a>
            </div>
